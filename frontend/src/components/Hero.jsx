...
import { Github, Linkedin, Mail, Shield, Terminal, Lock, Network, Activity, Cloud, Crosshair } from 'lucide-react';
...
export default function Hero() {
  ...
  const commands = [
    ...
    '$ burpsuite --scan target.example.com',
    '$ promptfoo eval --config llm-security.yaml',
    '$ ansible-playbook harden-cluster.yml',
    '> Scanning AI model endpoints...',
    '> Threat detected: 0',
    '> System status: SECURED',
    '$ nmap -sS -A target.net',
  ];
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  ...
                  <span className="text-sm text-[#155724] font-mono font-semibold">AI Security</span>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  ...
                  className="inline-flex items-center space-x-2 px-4 py-2 bg-[#155724]/10 border border-[#155724]/30 rounded-lg shadow-sm"
                >
                  <Cloud className="w-4 h-4 text-[#155724]" />
                  <span className="text-sm text-[#155724] font-mono">Cloud Architect</span>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  ...
                  className="inline-flex items-center space-x-2 px-4 py-2 bg-[#155724]/10 border border-[#155724]/30 rounded-lg shadow-sm"
                >
                  <Crosshair className="w-4 h-4 text-[#155724]" />
                  <span className="text-sm text-[#155724] font-mono">Offensive Security</span>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <span className="text-sm text-[#155724] font-mono">SRE</span>
                </motion.div>
              </div>
              ...
              <div className="w-full h-full bg-gray-900 rounded-lg shadow-2xl border border-[#155724]/30 overflow-hidden">
                ...
                <div className="bg-gray-800 border-b border-[#155724]/30 px-4 py-3 flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs text-gray-400 font-mono">security-ops</span>
                  </div>
                  <div className="w-16" />
                </div>
                ...
                <div className="p-6 h-full overflow-hidden relative">
                  ...
                  <div className="space-y-2 font-mono text-sm">
                    <div className="flex items-center space-x-2 text-gray-500 mb-4">
                      <span className="text-[#155724]">root@security-ops</span>
                    ...
                    <div className="space-y-1">
                      {terminalLines.map((line, index) => (
                        <motion.div
                          ...
                          className={`text-gray-300 ${line.text.startsWith('>') ? 'text-[#155724]' : 'text-gray-400'
                            }`}
                        >
